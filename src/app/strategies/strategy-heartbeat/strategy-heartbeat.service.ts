...
export class StrategyHeartbeatService {
  ...
  getSettings(): Observable<Setting[]> {
    return this.http.get<Setting[]>(`${this.settingsService.settings.strategyHeartbeatService}/v1/settings`)
      .pipe(
  ...
  saveSettings(body: any): Observable<any> {
    ...
    return this.http.post(`${this.settingsService.settings.strategyHeartbeatService}/v1/settings`, body).pipe(
